...
<html lang="en" dir="ltr">
  ...
  <div id="enviar">
    ...
    <select name="Pais" id="Pais">
	  ...
	  <img id="imagen" src="../vista/imagenes/codigo.jpg" border="1" width="160" height="80"/> <br> <br>
</div>

    <input type="button" name="Enviar" value="Enviar" onclick="EnviarDatos()" style='width:70px; height:40px'>
  </div>


<script src="../control/cInsertar.js" ></script>
